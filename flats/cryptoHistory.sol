...
// File: contracts\cryptoHistory.sol
...
contract cryptoHistory is ERC721, Ownable {
    ...
    // card to this set. I have no idea WTF is going on "D
    mapping(address => EnumerableSet.UintSet) private cardsToForge;
    ...
    function getAllCards() public view returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < totalCards; i++) {
            cards[i] = cardsToForge[owner()].at(i);
        }
