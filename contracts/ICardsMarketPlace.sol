...
/*
 * Market place to trade cards (should **in theory** be used for any ERC721 token)
 * It needs an existing cryptoHistory contract to interact with
 ...
 */
interface ICardsMarketPlace {
    event MarketTransaction(string TxType, address owner, uint256 tokenId);

    /**
     * Set the current cryptoHistory address and initialize the instance of cryptoHistory.
     * Requirement: Only the contract owner can call.
     */
    function setKittyContract(address _cryptoHistoryAddress) external;
